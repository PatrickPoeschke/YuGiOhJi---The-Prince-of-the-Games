...
public class GameState {
    ...
    public boolean isSwitchingOnBodyAsAShieldRule;
    public boolean isSwitchingOnCheatModeChangingRule;
    public boolean isSwitchingOnOncePerTurnRule;
    public boolean isSwitchingOnAntiDragonRulerRule;
    public int intNumberOfCardsDrawnAtBeginning;
    public int initialLP;
    
    public boolean isSwitchingOnShowDrawDialog;
    public boolean isSwitchingOnRescalingFontsize;
    public boolean isSwitchingOnInfoDialogs;
    public boolean isSwitchingOnStrategyDialogs;
    ...
    public GameState() {
        ...
        this.isSwitchingOnAntiDragonRulerRule = false;
    ...
    public void openModsDialog() { // can only change maximum LP while not playing (otherwise would collide somewhere)
        if (!isPlaying()) {
            int intDialogResult = multipleChoiceDialog("Which rule do you want to change?", "Modify Game?", new String[]{"\"My Body As A Shield\" rule", "\"Cheat Mode Changing\" rule", "\"Once Per Turn\" rule", "\"Anti Dragon Ruler\" rule", "no. of cards drawn at start", "LP at start"}, "");
            switch (intDialogResult) {
                case 0:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    intDialogResult = multipleChoiceDialog("If switched on, ENDBOSSES can not special summon themselves from graveyard.", "Switch on \"Anti Dragon Ruler\" rule?", new String[]{"Play with rule!", "Play without rule (default)!"}, "Play without rule (default)!");
                    switch (intDialogResult) {
                        case 0: isSwitchingOnAntiDragonRulerRule=true; informationDialog("switching rule on", ""); break;
                        default: isSwitchingOnAntiDragonRulerRule=false; informationDialog("switching rule off", ""); break;
                    }
                    updateVisibilityOfRules();
                    break;
                case 4:
    ...
    public void updateVisibilityOfRules() {
        ...
        YuGiOhJi.displayAntiDragonRulerRule.setVisible(isSwitchingOnAntiDragonRulerRule);
    }
