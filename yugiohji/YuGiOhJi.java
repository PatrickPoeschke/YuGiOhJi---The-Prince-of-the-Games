...
public class YuGiOhJi extends JFrame implements ActionListener, MouseListener, ComponentListener
{
    ...
    public YuGiOhJi(){
        ...
        displayCheatChangeRule.setBounds(1010, 150, 180, 50);
        ...
        displayOncePerTurnRule.setBounds(1010, 200, 180, 50);
    ...
    public static void rescaleEverything() {
        ...
        rescaleLabel(displayCheatChangeRule, 1010, 150, 180, 50);
        rescaleLabel(displayOncePerTurnRule, 1010, 200, 180, 50);
    ...
    public void actionPerformed (ActionEvent ae){
        ...
        if (ae.getSource() == YuGiOhJi.buttonInfo) { // one can change the code of this button to any method call in order to test any method
            informationDialog("<html>This game has been programmed by Patrick P&ouml;schke.</html>", "version 1.0");
        } // maybe also show summary of rules here? (write in another file)
