...
public class EStack {
    ...
    public static void equipMonster (SummonedMonster SumMonster, YCard Card, boolean isPlayersEquipCard, boolean isOriginallyPlayersEquipCard) {
        if (Card.lowMonster.equals(Mon.BuggedUpgrade) && isPlayersEquipCard && !SumMonster.isPlayersMonster) {YMonster.negatedPreventively();} // just for statistics (if one used Bugged Upgrade to negate opponent)
