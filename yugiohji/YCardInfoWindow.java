...
public class YCardInfoWindow implements ComponentListener {
    ...
    public static void setSumMonsterProperties (SummonedMonster SumMonster) {
        ...
        else if (SumMonster.isUsingEffectsOfOtherMonster) {
            additionalInfoAtTop = additionalInfoAtTop + "<br>* currently uses the effects of " + YMonster.getMonsterById(SumMonster.otherEffectMonsterID).monsterName + "<br>"
                    + "card text of copied effects:<br>"
                    + SumMonster.Monster.copyableEffect + "<br>";
        }
